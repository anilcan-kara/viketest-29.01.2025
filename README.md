Generated with [Bati](https://batijs.dev) ([version 332](https://www.npmjs.com/package/create-bati/v/0.0.332)) using this command:

```sh
bun create bati --react --tailwindcss --shadcn-ui --hono --drizzle --google-analytics --eslint --prettier
```
